        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          {{-- <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
              <a href="{{route('equiposIndex')}}" class="nav-link">
          ...
          {{-- <li class="nav-item">
            <a href="{{route('equiposIndex')}}" class="nav-link">
              ...
              <p>
                  Inventario
                  <span class="right badge badge-info">Equipos</span>
              </p>
            </a>
          </li> --}}
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
             ...
             @can('equipos.create')
                 <li class="nav-item">
                <a href="{{route('equiposList')}}" class="nav-link">
            ...
            @can('salida.list')
              <li class="nav-item">
                <a href="{{route('salidaList')}}" class="nav-link">
            ...
            @can('factura.list')
              <li class="nav-item">
                <a href="{{route('listFacturas')}}" class="nav-link">
          ...
          @can('tickets.index')
             <li class="nav-item">
            <a href="{{route('ticketsIndex')}}" class="nav-link">              
          ...
          @can('soporte.index')
             <li class="nav-item">
            <a href="{{route('tecnicoIndex')}}" class="nav-link">
          ...
          @can('programacion.index')
            <li class="nav-item">
            <a href="{{route('programacionIndex')}}" class="nav-link">
          ...
          @can('user.create')
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="{{route('permisosIndex')}}" class="nav-link">
                    <i class="fas fas fa-key nav-icon"></i>
                    <p>Permisos</p>
                  </a>
                </li>              
              </ul>
          ...
          {{-- @can('nodo.index')
            <li class="nav-item">
            <a href="{{route('nodoIndex')}}" class="nav-link">
              <i class="nav-icon fas fa-broadcast-tower"></i>
              <p>
                Nodos
          ...
          <li class="nav-item">
          <a href="{{route('programacionVista')}}" class="nav-link">
              <i class="nav-icon far fa-calendar-alt"></i>
              <p>
                Programacion
