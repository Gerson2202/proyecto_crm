<script>
    var idTickett=$('#txtIdMensaje').html(); 
      ...
      // TABLA DE IMAGENES
        ...
        var tablaImg=$('#tableImgTickets').DataTable({
          "ajax": '/ticket/imagenes/list/'+idTickett,
          "columns": [
              {data: 'id'},
              {data: 'url'},
          ...
          "columnDefs": [ {
                                  ...
                                  "render": function ( data, type, row, meta ) {
                                    return ' <li class="list-inline-item"><img style="width:185px; height:185px;" src = "'+data+'" ></li> ';
                                  }
                                },
                                ],
          responsive:true,
